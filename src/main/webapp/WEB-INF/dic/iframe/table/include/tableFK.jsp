...
<div id="tableFKDiv" style="height: 500px; width: 100%;">
	...
	<div id="tabFKDiv" style="width: 600px;">
		<table id="tableFKColumnsDatagrid" class="easyui-datagrid"
			...
			data-options="rownumbers:true,
					...
					onDblClickRow: onDblClickRowFKCol,selectOnCheck:false,checkOnSelect:false">
			<thead>
				<tr>
					<th data-options="field:'columns',width:155">列</th>
					<th id="checkboxFK" data-options="field:'checkbox',checkbox:true">选择</th>
					<th data-options="field:'select',width:155,formatter:refColFormatter,editor:{type:'combobox',options:{
					valueField:'fId',
					textField:'fName',
					panelHeight:'auto',
					editable:false,
