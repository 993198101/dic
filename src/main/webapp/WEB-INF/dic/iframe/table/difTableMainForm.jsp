...
<div>
    <div id="difTableMaintab" class="easyui-tabs" style="width:100%;height:500px;position:relative" data-options="onSelect:onSelect">
        <div title="主键管理" style="padding:10px">
            <jsp:include page="include/difTablePK.jsp" flush="true" />
        </div>
...
<script type="text/javascript" src="<%=path%>/dic/js/difTableMainForm.js"></script>
</body>
</html>