...
<div class="dhcc-search-form">
    ...
    <div class="dhcc-input-div">
        <input class="easyui-datebox dhcc-input-width" data-options="editable:false "
               name="dDate" id="dDate">
    </div>
    <span style="display: inline-block; width: 20px;"></span>
    ...
    <div class="dhcc-input-div">
        <select id="choseDatabaseType" class="easyui-combobox"
                name="dDatabaseType"
                data-options="valueField:'id',textField:'text',url:'../sysDatasource/getSysDatabaseTypeSelect'"
                style="width: 200px;">
            <!--option 在url获取  -->
        </select>
    </div>
...
<div class="dhcc-table-list">
    <table id="dataGrid" class="easyui-datagrid" style="width: 99%"
           data-options="url:'../sysDatasource/getSysDatasourcesByPage?dOfProject=${projectId} ',pagination:true,pageNumber:0,pageSize:10,cache:false,
...
<div id="w" class="easyui-window dhcc-model" title="系统数据源新增<span>表单</span>"
     data-options="modal:true,closed:true,cls:'theme-panel-red'">
    <form id="addSysDatasourceForm" class="theme-login-form" method="get" action="/sysDatasource/addSysDatasource"
        ...
        <label class="dhcc-label">选择数据库类型:</label>
        <div class="dhcc-input-div">
            <select class="easyui-combobox dhcc-input-width" name="dDatabaseType"
                    data-options="valueField:'id',textField:'text',url:'../sysDatasource/getSysDatabaseTypeSelect',required:true,editable:false">
                <!--option 在url获取  -->
            </select>
        </div>
        <span style="display:inline-block;width:20px;"></span>
        ...
        <div class="dhcc-input-div">
            <input type="text" class="easyui-textbox dhcc-input-width" name="dPassword"
                   data-options="prompt:'输入数据源密码...',required:true,validType:'length[1,20]'"/>
        </div>
        <span style="display:inline-block;width:20px;"></span>
        ...
        <div class="dhcc-input-div">
            <input type="text" class="easyui-textbox dhcc-input-width" name="dPort"
                   data-options="prompt:'输入数据源端口...',required:true,validType:'isValidPort'"/>
        </div>
        <span style="display:inline-block;width:20px;"></span>
        <label class="dhcc-label">服务名:</label>
        <div class="dhcc-input-div">
        ...
        <div class="dhcc-search-button-div">
            <button type="button" onclick="submitForm()" class="easyui-linkbutton button-line-yellow">提交</button>
            <button type="button" onclick="back()" class="easyui-linkbutton button-line-green">返回</button>
        </div>
    </form>
    <iframe name='formTargetIframe' style='display: none;'></iframe>
</div>
<script src="<%=path %>/dic/js/sysDatasourceTable.js"></script>
</body>
</html>
